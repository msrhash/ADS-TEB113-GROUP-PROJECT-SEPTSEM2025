# ADS-TEB113-GROUP-PROJECT-SEPTSEM2025
## Group Members
...
3. The program will display either:
- Direct route found (baseline)
- Route found with all stations in the path (optimized)
- Route not found if no path exists.
4. After each search, you can choose to:
 - c – continue searching for another route
 - q – quit the program
